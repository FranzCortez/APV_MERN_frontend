...
const Registrar = () => {
    ...
    return (
      <>
        <div>
            <h1 className='text-indigo-600 font-black text-6xl'>Crea tu Cuenta y Administrar {""}<span className='text-black'>tus Pacientes</span></h1>
        </div>
        ...
        <div className='mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white'>
            ...
            <form action="" onSubmit={handleSubmit}>
                <div className='my-5'>
                    ...
                    placeholder='Tu Nombre' type="text" value={nombre} onChange={e => setNombre(e.target.value)} />
                </div>

                <div className='my-5'>
                    <label className='uppercase text-gray-600 block text-xl font-bold' htmlFor="">Email</label>
                    <input className='border w-full p-3 mt-3 bg-gray-50 rounded-xl' 
                    placeholder='Tu Email' type="email" value={email} onChange={e => setEmail(e.target.value)}  />
                </div>

                <div className='my-5'>
                    <label className='uppercase text-gray-600 block text-xl font-bold' htmlFor="">Password</label>
                    <input className='border w-full p-3 mt-3 bg-gray-50 rounded-xl' 
                    placeholder='Tu Password' type="password" value={password} onChange={e => setPassword(e.target.value)}  />
                </div>

                <div className='my-5'>
                    <label className='uppercase text-gray-600 block text-xl font-bold' htmlFor="">Repetir tu password</label>
                    <input className='border w-full p-3 mt-3 bg-gray-50 rounded-xl' 
